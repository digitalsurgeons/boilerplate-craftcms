...
return [
    ...
    "Upgrade to Pro for more options"                                                                                                                                                                                                      => "Upgrade to Pro for more options",
    ...
    "Use only date, time or both"                                                                      => "Use only date, time or both",
    "Generate Placeholder"                                                                             => "Generate Placeholder",
    "Enable this to automatically generate a placeholder based on the given date format settings"      => "Enable this to automatically generate a placeholder based on the given date format settings",
    ...
    "If enabled will use the leading zero for days and months"                                         => "If enabled will use the leading zero for days and months",
    "Date Separator"                                                                                   => "Date Separator",
    "Used to separate dates"                                                                           => "Used to separate dates",

    // TIME
    "24h clock?"                                                                                       => "24h clock?",
    "Hours leading zero?"                                                                              => "Hours leading zero?",
    ...
    "AM/PM separator"                                                                                  => "AM/PM separator",
    "Used to separate time from AM/PM"                                                                 => "Used to separate time from AM/PM",
